...
const AcpOrders = () => {
  const acpOrders = useSelector(state => state.order.orders)
  ...
  return (
    <div>
      ...
      <Container>
        <Typography variant="h4" color="#ac1717" fontWeight="600" sx={{ m: "0 0 5px 0" }} style={{ marginTop: "-50px", marginBottom: "20px" }}>
          Accepted Orders
        </Typography>
        ...
        <div>
          <MDBCol md="12">
            <input className="form-control"
              ...
              placeholder="Search"
              aria-label="Search"
              onChange={searchInquiry}
              style={{width:"500px",marginBottom: "20px",marginLeft:"50rem"}}
            />
          </MDBCol>
        </div>
